...
`run_remote.py` is the user-facing entry point. It delegates to
`run_balance_steering.py`.

### Runtime orchestrator

`run_balance_steering.py` owns:
...
- `run_remote.py`: complete balance, drive, and steering application.
